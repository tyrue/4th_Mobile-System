...
public class AlertService extends Service {
    ...
    public void onCreate() {
        ...
        pm = (PowerManager)getSystemService(Context.POWER_SERVICE); // 파워 매니저
        wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Tag: partial wake lock"); // 계속 켜있게 하는 wake lock
    }
...
// 사실 cpu를 쓰는 시간은 스캔하는 시간 3초만 있으면 되는데, 이건 스크린을 계속 켜두기 때문에
// 낭비하는 자원이 많다. 이걸 어떻게 하면 좋을까? 스캔할 때만 스크린을 켜두게 하고 끄게 하면 좋을 텐데